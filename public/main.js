...
document.addEventListener("DOMContentLoaded", () => {
  ...
  if (bannerText && bannerImage && cards) {
    cards.forEach((item) => {
      item.style.opacity = 1;
      item.style.transform = "translate(0px)";
    });
    bannerText.style.opacity = 1;
    bannerText.style.transform = "translate(0px)";
    bannerImage.style.opacity = 1;
    bannerImage.style.transform = "translate(0px)";
  }
  ...
  item.addEventListener("click", function animationHandler(e) {
    ...
    if (bannerText && bannerImage && cards) {
      cards.forEach((item) => {
        ...
        item.style.transform = "translate(180px)";
      });
      bannerText.style.opacity = 0;
      bannerText.style.transform = "translate(150px)";
      bannerImage.style.opacity = 0;
      bannerImage.style.transform = "translate(150px)";
    }
